	 ...
	 <path sodipodinodetypes="ccccccccccccccccccccc" inkscapeconnector-curvature="0" className="st5" d="M166,399.2l70.5,18
		...
		c-1.3-6.5,9.5-18.5,19.3-10.3c9.4,3.5,21.3,22.7,34,46c-1.1,18.9-2.3,42.5,3.5,71.5C166.6,365,166.3,382.8,166,399.2z"> 
			...
			<text x="193" y="275" fontFamily="Verdana" fontSize="50" fill={props.flip ? props.color : 'white'} {...props.flip && {transform:"scale(-1,1) translate(-490)"}}> 
			 ...
			 <text x={(props.number < 10) ? "226" : "190"} y="365" fontFamily="sans-serif" fontSize="100" fontWeight='bold' fill={props.flip ? props.color : 'white'}  {...props.flip && {transform:"scale(-1,1) translate(-490)"}}>
